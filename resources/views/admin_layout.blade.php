    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                ...
                <span class="username"><a href="{{URL::to('/admin/logout')}}">{{Session::get('admin_name')}}</a></span>
                <b class="caret"></b>
            </a>
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('admin/add-product')}}">Them danh muc</a></li>
						<li><a href="{{URL::to('admin/list-product')}}">Liet ke danh muc</a></li>
                    </ul>       
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('admin/them-san-pham')}}">Them San Pham</a></li>
						<li><a href="{{URL::to('admin/danh-sach-san-pham')}}">Danh sach san pham</a></li>
                    </ul>       
                </li>
                </div>
        <!-- sidebar menu end-->
